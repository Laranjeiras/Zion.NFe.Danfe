...
namespace ZionDanfe
{
    internal class DanfePagina
    {
        ...
        {
            Gfx.DrawString($"[ZionDanfe] {Strings.TextoCreditos}", RetanguloCreditos, Danfe.EstiloPadrao.CriarFonteItalico(6), AlinhamentoHorizontal.Direita);
        }
